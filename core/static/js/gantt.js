...
class Gantt {
    ...
    SalidaTable() {
        ...
        // Agregar dos columnas adicionales a la izquierda
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">Linea Produccion</th>';/**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">Cliente</th>';/**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">Item</th>'; /**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">Folio</th>'; /**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">Cliente</th>'; /**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">OP</th>'; /**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">Mercado</th>'; /**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">Productos</th>';/**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">ETA</th>';/**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">L/A/AL</th>';/**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">PQTES.Solicitados</th>';/**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">PQTES.Saldo</th>';/**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">Trozos</th>';/**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">Ø</th>';/**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">Largo Trozos</th>';/**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">Grado de Urgencia</th>';/**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">Lateral</th>';/*por determinar*/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">Nota</th>';/**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">Cant.desep.de 20MM</th>';/**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">Largo del Taco</th>';/**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">OBS</th>';/**/
        html += '<th style="color: white; width: 30vh; font-size: 13px; height:3vh;">M3 Prod.</th>';/**/
        ...
        for (let i = 0; i < this.filteredTasks.length; i++) {
            ...
            for (let j = 0; j < task[7].length; j++) { // Itera sobre la lista de productos en task[11]
                ...
                bodyHtml += `<td  left-align></td>`;/*Linea de Produccion*/
                bodyHtml += `<td  left-align>${task[5]}</td>`;/*Cliente*/
                bodyHtml += `<td></td>`;/*Item*/
                bodyHtml += `<td  left-align></td>`;/*Folio  / pedido id?*/
                bodyHtml += `<td  left-align></td>`;/*Cliente*/
                bodyHtml += `<td></td>`;/*OP*  / pedido id?*/
                bodyHtml += `<td  left-align></td>`;/*Mercado*/
                bodyHtml += `<td  left-align>${product}</td>`;/*Producto*/
                bodyHtml += `<td center></td>`;/*ETA*/
