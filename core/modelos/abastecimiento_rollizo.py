...
class AbastecimientoRollizo(models.Model):
    ...
    id_rollizo = models.ForeignKey('Rollizo', on_delete=models.CASCADE, db_column='id_rollizo', verbose_name='Rollizo', blank=True, null=True)
    id_periodo = models.ForeignKey('Periodo', on_delete=models.CASCADE, db_column='id_periodo', verbose_name='Periodo', blank=True, null=True)
