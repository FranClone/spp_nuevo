...
class ProductoCorte(models.Model):
    ...
    id_patron = models.ForeignKey('PatronCorte', on_delete=models.CASCADE, verbose_name='Patrón de Corte', db_column='id_patron', blank=True, null=True)
    ...
    id_rollizo = models.ForeignKey('Rollizo', on_delete=models.CASCADE, db_column='id_rollizo', blank=True, null=True)
